...
import image3 from "../images/linkedin-icon.png";
import image4 from "../images/instagram-icon.png";
    ...
    <div className="container-fluid">
      <div className="row footer">
          ...
          <div className="row">
            ...
            <div className="col-sm-8">
              <p>
                ...
                purus sit amet bibendum mollis, urna elit egestas dui, a finibus
                elit massa vitae est. Praesent ut elementum justo. Morbi eu
                lectus et augue commodo cursus id sit amet massa. Vivamus
                tristique tellus id velit tempor hendrerit.
              </p>
            </div>
            <div className="col-sm-2"></div>
          </div>
        ...
        <div className="col-sm-12 end p-3 pb-1">
          <p>&copy;2019 All Rights Reserved. Free html Templates</p>
        </div>
      </div>
    </div>
  );
